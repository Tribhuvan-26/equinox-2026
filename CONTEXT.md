...
| `ipl-auction` | IPL Auction | **Done** | 4.5s motion video & pixel-identical animation pass: 26 extracted layers, 6-phase choreography, gavel strike + paddle wave + team logo stagger, standalone HTML/SVG player + Next.js GSAP overlay |
