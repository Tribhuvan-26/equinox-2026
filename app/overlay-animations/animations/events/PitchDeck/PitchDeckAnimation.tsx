    ...
    >
      ...
      <div ref={stageFrameRef} className={styles.stageFrame}>
        ...
        >
          ...
          <g ref={leftBannerRef}>
            <rect x="38" y="180" width="98" height="175" fill="#0058ff" rx="2" />
          ...
          <g ref={rightBannerRef}>
            <rect x="888" y="180" width="98" height="175" fill="#0058ff" rx="2" />
            <g textAnchor="middle" fill="#ffffff">
          ...
          <g ref={lampLeftGroupRef}>
            <line x1="237" y1="0" x2="237" y2="52" stroke="#11161d" strokeWidth="2.5" />
            <path
              d="M217,74 C217,54 225,50 237,50 C249,50 257,54 257,74 Z"
              fill="#11161d"
            />
            <rect x="214" y="73" width="46" height="3" rx="1.5" fill="#11161d" />
            <circle cx="237" cy="76" r="3" fill="#ffffff" />
          </g>

          {/* Right Lamp (x=787) */}
          <g ref={lampRightGroupRef}>
            <line x1="787" y1="0" x2="787" y2="52" stroke="#11161d" strokeWidth="2.5" />
            <path
              d="M767,74 C767,54 775,50 787,50 C799,50 807,54 807,74 Z"
              fill="#11161d"
            />
            <rect x="764" y="73" width="46" height="3" rx="1.5" fill="#11161d" />
          ...
          <g ref={plantLeftRef} transform="translate(47, 470)">
            <path d="M0,0 C-15,-30 -30,-45 -35,-60 C-25,-55 -5,-25 0,0 Z" fill="#0058ff" />
            <path d="M0,0 C-10,-45 -18,-70 -20,-85 C-10,-75 0,-40 0,0 Z" fill="#0058ff" />
            <path d="M0,0 C-5,-50 0,-90 0,-100 C5,-90 10,-50 0,0 Z" fill="#0058ff" />
            <path d="M0,0 C10,-45 18,-70 20,-85 C10,-75 0,-40 0,0 Z" fill="#0058ff" />
            <path d="M0,0 C15,-30 30,-45 35,-60 C25,-55 5,-25 0,0 Z" fill="#0058ff" />
            <polygon points="-18,0 18,0 13,32 -13,32" fill="#11161d" />
          </g>
          ...
          <g ref={screenFrameGroupRef}>
            ...
            <rect x="281" y="82" width="6" height="19" rx="1" fill="#11161d" />
            <rect x="737" y="82" width="6" height="19" rx="1" fill="#11161d" />
            <rect x="285" y="85" width="454" height="14" rx="2" fill="#11161d" />
            {/* Side black frame lines */}
            <line x1="295" y1="99" x2="295" y2="369" stroke="#11161d" strokeWidth="2" />
            <line x1="728" y1="99" x2="728" y2="369" stroke="#11161d" strokeWidth="2" />
          </g>
          ...
          <g ref={screenContentGroupRef} clipPath="url(#pd-screen-clip)">
            ...
            <g ref={taglineBlockRef}>
              {/* Blue accent bar */}
              <rect x="316" y="238" width="34" height="3" fill="#1856f3" rx="1.5" />
              {/* Tagline */}
            ...
            <g ref={chartBadgeRef}>
              ...
              <text x="683" y="117" textAnchor="middle" fill="#1856f3" fontSize="8.5" fontWeight="900" fontFamily="var(--font-mono), monospace">
                +84%
              </text>
            </g>
            ...
            <g ref={iconRow1Ref} transform="translate(528, 206)">
              ...
              <circle cx="10" cy="9" r="3" fill="#1856f3" />
              <path d="M5,19 C5,15 8,14 10,14 C12,14 15,15 15,19 Z" fill="#1856f3" />
              <circle cx="16" cy="9.5" r="2.2" fill="#60a5fa" />
              <path d="M14,19 C14,16 16,15.5 18,15.5 C19.5,15.5 21,16 21,19 Z" fill="#60a5fa" />
              {/* Labels */}
            ...
            <g ref={iconRow2Ref} transform="translate(528, 248)">
              ...
              <path
                ...
                fill="#1856f3"
              />
              <line x1="10.5" y1="18" x2="13.5" y2="18" stroke="#1856f3" strokeWidth="1.2" strokeLinecap="round" />
              {/* Labels */}
              <text x="32" y="11" className={styles.iconLabelTitle} fontSize="9.5">
                MENTORS
              </text>
            ...
            <g ref={iconRow3Ref} transform="translate(528, 290)">
              ...
              <polygon points="12,5 14,10 19,12 14,14 12,19 10,14 5,12 10,10" fill="#1856f3" />
