...
export const StartupExpoSceneSvg = React.forwardRef<SVGSVGElement, StartupExpoSceneSvgProps>(
  ({ className }, ref) => {
    return (
      ...
      >
        <defs>
          <linearGradient id="expoEquinoxGrad" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#7484FE" />
            <stop offset="100%" stopColor="#33FF67" />
          </linearGradient>
          <filter id="expoTextShadow" x="-20%" y="-20%" width="140%" height="140%">
          ...
          <linearGradient id="lampConeBeamGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="var(--equinox-green)" stopOpacity="0.75" />
            <stop offset="25%" stopColor="var(--equinox-green)" stopOpacity="0.4" />
            <stop offset="60%" stopColor="var(--equinox-periwinkle)" stopOpacity="0.15" />
            <stop offset="100%" stopColor="var(--equinox-dark)" stopOpacity="0.0" />
          </linearGradient>
          <linearGradient id="lampCoreBeamGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="var(--equinox-offwhite)" stopOpacity="0.85" />
            <stop offset="50%" stopColor="var(--equinox-green)" stopOpacity="0.35" />
            <stop offset="100%" stopColor="var(--equinox-dark)" stopOpacity="0.0" />
          </linearGradient>
        ...
        <g id="side-banners" className="side-banners">
          <g id="side-banner-right">
            <line x1="1470" y1="0" x2="1470" y2="40" stroke="var(--equinox-dark)" strokeWidth="2.5" strokeLinecap="round" />
            <line x1="1570" y1="0" x2="1570" y2="40" stroke="var(--equinox-dark)" strokeWidth="2.5" strokeLinecap="round" />
            <g id="side-banner-right-body" style={{ transformOrigin: "1520px 40px" }}>
              <rect x="1445" y="40" width="150" height="235" rx="6" fill="var(--equinox-blue)" stroke="var(--equinox-dark)" strokeWidth="2.5" strokeLinejoin="round" />
              <text x="1520" y="78" textAnchor="middle" fill="var(--equinox-white)" fontFamily="'Space Grotesk', sans-serif" fontWeight="900" fontSize="13.5" letterSpacing="2.5">
        ...
        {/* FLOOR TEXTURE SHADING (Subtle Floor Accents) */}
        <g id="crack-debris">
          <ellipse cx="600" cy="855" rx="140" ry="12" fill="#202020" opacity="0.6" />
          <ellipse cx="800" cy="850" rx="90" ry="8" fill="#1C1C1C" opacity="0.5" />
          <ellipse cx="1100" cy="860" rx="180" ry="14" fill="#202020" opacity="0.6" />
        </g>
        ...
        <g id="plant-left">
          ...
          />
          <path d="M 85 845 C 80 790 77 750 75 718" stroke="var(--equinox-dark)" strokeWidth="2.5" strokeLinecap="round" />
          ...
          <path
            ...
            strokeLinejoin="round"
          />
          <path d="M 85 845 C 64 804 49 773 40 738" stroke="var(--equinox-dark)" strokeWidth="2.5" strokeLinecap="round" />
          ...
          <path
            ...
            strokeLinejoin="round"
          />
          <path d="M 85 845 C 101 805 116 779 128 753" stroke="var(--equinox-dark)" strokeWidth="2.5" strokeLinecap="round" />

          {/* Stem base joint */}
          <circle cx="85" cy="845" r="3.5" fill="var(--equinox-dark)" />
        </g>
        ...
        <g id="plant-right">
          ...
          <path
            ...
            strokeLinejoin="round"
          />
          <path d="M 1585 845 C 1580 790 1577 750 1575 718" stroke="var(--equinox-dark)" strokeWidth="2.5" strokeLinecap="round" />
          ...
          <path
            ...
            strokeLinejoin="round"
          />
          <path d="M 1585 845 C 1564 804 1549 773 1540 738" stroke="var(--equinox-dark)" strokeWidth="2.5" strokeLinecap="round" />
          ...
          <path
            ...
            strokeLinejoin="round"
          />
          <path d="M 1585 845 C 1601 805 1616 779 1628 753" stroke="var(--equinox-dark)" strokeWidth="2.5" strokeLinecap="round" />

          {/* Stem base joint */}
          <circle cx="1585" cy="845" r="3.5" fill="var(--equinox-dark)" />
        </g>
        ...
        <g id="lamp-fixture">
          <line x1="349" y1="0" x2="349" y2="70" stroke="var(--equinox-dark)" strokeWidth="2.5" strokeLinecap="round" />
          <rect x="345" y="68" width="8" height="10" rx="2" fill="var(--equinox-dark)" stroke="var(--equinox-dark)" strokeWidth="2.5" />
          <path
            ...
            strokeLinejoin="round"
          />
          <rect x="306" y="124" width="86" height="8" rx="3" fill="var(--equinox-dark)" stroke="var(--equinox-dark)" strokeWidth="2.5" />
          <ellipse cx="349" cy="138" rx="14" ry="12" fill="var(--equinox-offwhite)" stroke="var(--equinox-dark)" strokeWidth="2.5" />
          <circle id="lamp-bulb-glow" cx="349" cy="138" r="32" fill="var(--equinox-green)" opacity="0" filter="url(#bulbGlowFilter)" />
          <circle id="lamp-bulb-core" cx="349" cy="138" r="14" fill="var(--equinox-offwhite)" opacity="0" />
        </g>
        ...
        <g id="person-flag-group" opacity="0" style={{ transformOrigin: "1250px 420px" }}>
          <g transform="translate(162, 68)">
            ...
            <path
              ...
              strokeLinejoin="round"
            />
            {/* Crisp offwhite shoe soles grounded flush at y=352 */}
            <line x1="1069" y1="351" x2="1101" y2="351" stroke="var(--equinox-offwhite)" strokeWidth="2.5" strokeLinecap="round" />
            <line x1="999" y1="351" x2="1025" y2="351" stroke="var(--equinox-offwhite)" strokeWidth="2.5" strokeLinecap="round" />
        ...
        {/* LOGO BADGE (Top Left - Reference Wordmark Treatment) */}
        <g id="logo-badge">
          <rect x="90" y="44" width="180" height="68" rx="6" fill="var(--equinox-dark)" stroke="rgba(247, 242, 246, 0.2)" strokeWidth="2" strokeLinejoin="round" />
          <text x="180" y="68" textAnchor="middle" dominantBaseline="central" fontFamily="'Space Grotesk', sans-serif" fontWeight="900" fontSize="14" letterSpacing="1.5">
            <tspan fill="url(#expoEquinoxGrad)">THE </tspan>
            <tspan fill="var(--equinox-offwhite)" filter="url(#expoTextShadow)">EQUINOX</tspan>
          </text>
          <rect x="145" y="83" width="70" height="22" rx="4" fill="url(#expoEquinoxGrad)" />
          <text x="180" y="94" textAnchor="middle" dominantBaseline="central" fill="var(--equinox-dark)" fontFamily="'Space Grotesk', sans-serif" fontWeight="900" fontSize="13" letterSpacing="2">
            2.0
          </text>
        </g>
        ...
        <g id="date-tag">
          <rect x="90" y="132" width="180" height="510" rx="6" fill="var(--equinox-blue)" stroke="var(--equinox-dark)" strokeWidth="2.5" strokeLinejoin="round" />
          <g fontFamily="'Space Grotesk', sans-serif" fontWeight="900" fontSize="15" fill="var(--equinox-white)" letterSpacing="2.5" textAnchor="middle" dominantBaseline="central">
            ...
            <line x1="135" y1="485" x2="225" y2="485" stroke="var(--equinox-white)" strokeWidth="2.5" strokeLinecap="round" />
          </g>
          {/* 30 - 31 OCT Date Badge */}
          <rect x="108" y="560" width="144" height="44" rx="6" fill="var(--equinox-green)" stroke="var(--equinox-dark)" strokeWidth="2.5" strokeLinejoin="round" />
          <text x="180" y="582" textAnchor="middle" dominantBaseline="central" fill="var(--equinox-dark)" fontFamily="'Space Grotesk', sans-serif" fontWeight="900" fontSize="15" letterSpacing="2">
            30 - 31 OCT
          </text>
        </g>
        ...
        <g id="title-text">
          <g clipPath="url(#titleClip)">
            <text x="310" y="315" fontFamily="'Space Grotesk', 'Impact', sans-serif" fontWeight="900" fontSize="100" letterSpacing="2">
              <tspan fill="var(--equinox-offwhite)">STARTUP</tspan>
              <tspan fill="var(--equinox-blue)" dx="5">EXPO</tspan>
            </text>
          </g>
        </g>
        ...
        <g id="tagline-text" opacity="0">
          <text x="315" y="375" fontFamily="'Space Grotesk', sans-serif" fontWeight="900" fontSize="24" letterSpacing="4" fill="var(--equinox-offwhite)">SHOWCASE TODAY</text>
          <text x="315" y="410" fontFamily="'Space Grotesk', sans-serif" fontWeight="900" fontSize="24" letterSpacing="4" fill="var(--equinox-offwhite)">BUILD TOMORROW</text>
          <line x1="315" y1="430" x2="495" y2="430" stroke="var(--equinox-green)" strokeWidth="2.5" strokeLinecap="round" />
        </g>
      </svg>
    );
  }
