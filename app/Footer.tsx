...
export function Footer() {
  return (
    <footer
      id="site-footer"
      className="relative overflow-hidden border-t-2 border-white/20 bg-[#0c2b94] pt-20 pb-12 text-white"
    >
        ...
        <div className="flex flex-col justify-between gap-8 md:flex-row md:items-start">
          <div className="max-w-md">
            <div className="flex items-center gap-2">
              <span className="font-mono text-2xl font-black tracking-widest text-white uppercase">
                THE EQUINOX
              </span>
              <span className="rounded border border-white bg-white px-2 py-0.5 font-mono text-xs font-black text-[#0d0e15]">
                2.0
              </span>
            </div>
            ...
            <p className="mt-2 font-mono text-xs font-bold text-white/70">
